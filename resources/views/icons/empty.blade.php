<svg
        ...
        <defs
            ...
            <linear-gradient
                ...
                x2="264.33"
                y2="305.75"
                gradient-transform="matrix(0, -1, -1, 0, 760.81, 597.66)"
            />
            <linear-gradient
                ...
                x2="212.21"
                y2="316.28"
                gradient-transform="matrix(0, -1, -1, 0, 821.81, 562.29)"
            />
            <linear-gradient
                ...
                x2="295.6"
                y2="336.33"
                gradient-transform="matrix(0, -1, -1, 0, 768.63, 669.04)"
            />
            <linear-gradient
                ...
                x2="224.95"
                y2="350.6"
                gradient-transform="matrix(0, -1, -1, 0, 851.31, 621.1)"
            />
            <linear-gradient
                ...
                x2="627.39"
                y2="313.03"
                gradient-transform="matrix(-0.65, 0.76, 0.76, 0.65, 837.43, -649.66)"
                />
            <linear-gradient
                ...
                x2="303.02"
                y2="531.38"
                gradient-transform="translate(117.27 -574.84) rotate(32.36)"
                />
        </defs>
        <title
