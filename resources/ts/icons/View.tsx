...
export function View({size}: {size?: string}) {
    size = size || '1.5em'

    return <svg className="bi bi-eye" width={size} height={size} viewBox="0 0 20 20" fill="currentColor"
        ...
        <path fillRule="evenodd"
              ...
              clipRule="evenodd"/>
        <path fillRule="evenodd" d="M10 7.5a2.5 2.5 0 100 5 2.5 2.5 0 000-5zM6.5 10a3.5 3.5 0 117 0 3.5 3.5 0 01-7 0z"
              clipRule="evenodd"/>
    </svg>
}
