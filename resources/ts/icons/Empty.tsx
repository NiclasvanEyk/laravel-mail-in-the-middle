...
return <svg
    ...
    <path
        ...
        id="path31" />
    <polygon
        points="428.52,125.75 428.52,181.06 428.52,249.13 462.3,249.13 462.3,181.06 502.94,181.06 502.94,125.75 456.43,125.75 "
        id="polygon33"
        style={{fill: ":url(#459818a5-69c2-4f7f-8bb2-5507c3d29640)"}}
        transform="rotate(90,451.97522,231.95395)" />
    <polygon
        points="434.39,176.67 434.39,239.34 457.89,239.34 457.89,176.67 497.06,176.67 497.06,125.75 457.89,125.75 434.39,125.75 "
        id="polygon35"
        style={{fill: "#ffcc80"}}
        transform="rotate(90,444.87522,229.26395)" />
    <path
